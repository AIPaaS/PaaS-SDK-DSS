...
public interface IDSSClient {
	 ...
	 *            39.204068 ], [ 117.137809, 39.209659 ], [ 117.137666,
	 *            39.209547 ]
	 * @return  有重叠的多边形，返回true,没有则返回false
	 */
	public List<Document> withinPolygon(final String field, final List<double[]> coordinates);
	
	/**
	 * 判断是否存储内是否有输入的多边形有重叠,同时应用数据过滤条件，
	 * @param field 标识坐标的字段
	 * 
	 * @param where {"author":"xxxx","date":"xxxx"}或者{"startDate": {$lt: endDate}} 这种json格式的条件
	 * @param coordinates 
	 * 坐标数组，经度，维度对，一定要是闭合的，即第一个坐标和最后一个坐标一样，[ 117.137666, 39.209547 ],
	 *            [ 117.131629, 39.207087 ], [ 117.132204, 39.201719 ], [
	 *            117.135797, 39.196798 ], [ 117.14169, 39.201048 ], [
