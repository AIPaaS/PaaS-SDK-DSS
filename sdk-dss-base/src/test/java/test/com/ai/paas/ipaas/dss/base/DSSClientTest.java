...
public class DSSClientTest {
    private static final Logger log = LoggerFactory.getLogger(DSSClientTest.class);
    private static IDSSClient dssClient = null;
    private Gson gson = new Gson();

    @BeforeClass
    public static void setUpBeforeClass() throws Exception {
        dssClient = new DSSClient("127.0.0.1:27017", "test", "xiaoming", "123456", "test");
    }
    ...
    public void testSaveFileByChunk() {
        Long startTime = System.currentTimeMillis();
        log.info("开始时间戳：{} 毫秒", startTime);
        File file = new File("/Users/douxiaofeng/Downloads/sso-集成.rar");
    ...
    public void testReadById() throws Exception {
        ...
        String fileid = dssClient.save(file, "remark");
        // 开始插入
        byte[] bytes = dssClient.read(fileid);
         file = new File("/Users/douxiaofeng/Downloads/c.jpg");
    ...
    public void testReadByIdToFile() {
        ...
        String fileid = dssClient.save(file, "remark");
        // 开始插入
        dssClient.readToFile(fileid, "/Users/douxiaofeng/Downloads/b.jpg");
        Long endTime = System.currentTimeMillis();
        Long costTime = endTime - startTime;
        System.out.println("文件成功， 结束时间戳：" + endTime + "， 用时" + costTime + "毫秒");
    }
    ...
    public void testReadByIdToOut() throws Exception {
        ...
        dssClient.readToFile(fileid, out);
        out.close();
        Long endTime = System.currentTimeMillis();
        Long costTime = endTime - startTime;
        System.out.println("文件成功， 结束时间戳：" + endTime + "， 用时" + costTime + "毫秒");
